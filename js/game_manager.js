...
function caption(exp) {
  var caption = [];
  caption[2]    = 'california-style pizza';
  caption[4]    = 'piccola italia capelle aan den ijssel';
  caption[8]    = 'Italian cuisine';
  caption[16]   = 'da peppino express zürich';
  caption[32]   = 'pizza patron';
  caption[64]   = 'trader joe butternut squash pizza';
  caption[128]  = 'pepperoni';
  caption[256]  = 'cashew';
  caption[512]  = 'pajeon';
  caption[1024] = 'pizza commercial video template free';
  caption[2048] = 'california-style pizza';
